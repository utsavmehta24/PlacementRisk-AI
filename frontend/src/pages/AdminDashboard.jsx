      ...
      <div className="max-w-7xl mx-auto px-5 py-6 space-y-5">
        ...
        {activeTab === 'institutes' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
              <h3 className="font-semibold mb-3">{selectedInstitute ? selectedInstitute.name : 'Institute Drilldown'}</h3>
              {!selectedInstitute ? (
              ...
              {[
                {
                  ...
                  desc: 'Compute placement risk scores for all students who have not been scored yet.',
                  action: async () => {
                ...
                },
                {
                  ...
                  desc: 'Scan all students for risk deterioration and placement delays.',
                  action: async () => {
